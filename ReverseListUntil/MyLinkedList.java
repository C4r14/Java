...
public boolean delete(E item)
  ...
  public MyLinkedList reverseUntil(E element)
  {
      MyLinkedList returnList = new MyLinkedList<E>();
      
      Node<E> ptr = head;
       while (ptr!= null&& ((Comparable)ptr.element).compareTo(element)!= 0)
       {
           ptr=ptr.next;
       }
       if (ptr == null) // Element not found, reverse the entire linked list.
           {
            ptr = head;
            while (ptr!= null)
            {
                returnList.prepend(ptr.element);
                ptr = ptr.next;
            }
           }
       else // Reverse list until you reach a specific element.
       {
           Node<E> ptrSearch = head;
           while (((Comparable)ptrSearch.element).compareTo(ptr.element) != 0)
           {
               returnList.prepend(ptrSearch.element);
